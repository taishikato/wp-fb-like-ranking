  ...
  <form action="" method="POST">
    <table class="form-table">
      <tr>
        ...
        <td>
          <input required name="wp_fb_like_ranking_fbAppToken" type="text" id="wp_fb_like_ranking_fbAppToken" <?php if (!empty($WpFbLikeRankingFbAppToken)) echo 'value="' . $WpFbLikeRankingFbAppToken . '"'; ?> />
        </td>
      </tr>
    </table>
